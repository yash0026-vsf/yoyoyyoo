...
const SEARCH_ITEMS = [
  {
    label: "Dashboard",
    description: "Competency overview, radar chart & summary stats",
    to: "/dashboard",
    icon: LayoutDashboard,
    keywords: ["home", "overview", "welcome", "stats", "summary", "competency", "radar"],
  },
  {
    label: "Skill Gap Analysis",
    description: "View detailed skill gaps against cadre benchmarks",
    to: "/skill-gap-analysis",
    icon: TrendingDown,
    keywords: ["gap", "skill", "deficit", "benchmark", "assessment", "analysis"],
  },
  {
    label: "Learning Paths",
    description: "AI-recommended courses & NPTEL lectures",
    to: "/learning-paths",
    icon: Compass,
    keywords: ["course", "learning", "path", "nptel", "igot", "training", "video", "lecture"],
  },
  {
    label: "AI Assessment Quiz",
    description: "Take the adaptive diagnostic quiz",
    to: "/ai-assessment-quiz",
    icon: Sparkles,
    keywords: ["quiz", "assessment", "test", "diagnostic", "ai", "exam"],
  },
  {
    label: "Competency Assessment",
    description: "Review your competency profile & evidence",
    to: "/competency-assessment",
    icon: BookOpen,
    keywords: ["competency", "profile", "evidence", "resume", "assessment"],
  },
  {
    label: "Build Profile",
    description: "Update your cadre profile & credentials",
    to: "/build-profile",
    icon: BookOpen,
    keywords: ["profile", "build", "update", "credentials", "cadre", "designation"],
  },
];
...
const NOTIFICATIONS = [
  {
    ...
    title: "Skill Gap Alert: Python for Statistics",
    description:
      "Your Python proficiency is 2 levels below the DES cadre benchmark. Start the recommended NPTEL course.",
    time: "2 hours ago",
    unread: true,
  },
  {
    id: 2,
    icon: Sparkles,
    iconClass: "text-accent bg-accent-soft",
    title: "New AI Quiz Available",
    description:
      "A refreshed adaptive diagnostic quiz is available based on your updated competency profile.",
    time: "5 hours ago",
    unread: true,
  },
  {
    ...
    title: "Course Progress: Survey Sampling",
    description:
      'You completed Lesson 3 of "Survey Sampling Design" (NPTEL). Keep going!',
    time: "1 day ago",
    unread: false,
  },
  {
    ...
    title: "CPE Hours Reminder",
    description:
      "You need 7.5 more CPE hours to meet your annual iGOT Karmayogi capacity building target.",
    time: "2 days ago",
    unread: false,
  },
];
    ...
    <header className="sticky top-0 z-20 flex h-16 items-center gap-4 border-b border-border bg-card/95 px-4 backdrop-blur lg:px-8">
      ...
      <div className="relative hidden max-w-md flex-1 sm:block" ref={searchRef}>
        ...
        <input
          ...
          type="search"
          value={searchQuery}
          placeholder="Search pages, skills, courses..."
        ...
        <span
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-xs font-medium text-muted-foreground"
        >
          ⌘K
        </span>
